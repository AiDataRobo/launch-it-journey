  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto px-4 py-6 max-w-7xl">
                            ...
                            <Dialog>
                              ...
                              <DialogContent className="sm:max-w-3xl">
                                  ...
                                  <div className="col-span-2 space-y-4">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-gray-700">
                                        ...
                                        We're committed to innovation and creating a positive work environment.
                                      </p>
                                    </div>
                                  </div>
                                      ...
                                      <CardContent className="p-4">
                                        <div className="space-y-4">
                                          ...
                                          <div>
                                            ...
                                            <p className="text-jobonboard-purple font-medium">{job.salary}</p>
                                          </div>
                                ...
                                <DialogFooter>
                                  ...
                                  >
                                    {savedJobs.includes(job.id) ? (
                                      <Heart className="h-4 w-4 mr-2 fill-jobonboard-purple text-jobonboard-purple" />
                                    ) : (
        ...
        {/* CTA Section */}
        <div className="mt-12 bg-gradient-to-r from-jobonboard-purple to-jobonboard-blue rounded-xl p-8 text-white shadow-lg">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-3">Can't Find the Right Job?</h2>
            <p className="text-lg mb-6">
              Upload your resume and let recruiters find you. Get notifications when relevant opportunities match your profile.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button className="bg-white hover:bg-gray-100 text-jobonboard-purple" size="lg" asChild>
                <Link to="/resume-builder">Upload Resume</Link>
              </Button>
              <Button variant="outline" className="border-white text-white hover:bg-white/10" size="lg" asChild>
                <Link to="/profile">Create Job Alert</Link>
              </Button>
            </div>
          </div>
        </div>
